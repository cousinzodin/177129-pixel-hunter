...
${stats.win ? `<table class="result__table">
  <tr>
    ...
    <td class="result__total">${stats.correctPoints}</td>
  </tr>
  <tr>
    <td></td>
    ...
    <td class="result__total">${stats.fastPoints}</td>
  </tr>
  <tr>
    <td></td>
    ...
    <td class="result_points">× ${Points.BONUS}</td>
    <td class="result__total">${stats.livesPoints}</td>
  </tr>
  <tr>
    <td></td>
    ...
    <td class="result__total">${stats.slowPoints}</td>
  </tr>
  <tr>
